...
- **More UI languages** — requested 2026-09-25; order Spanish → Portuguese (Brazil) → German/French/Italian/Japanese (German needs an H-notation mode). **Spanish, Portuguese (Brazil), French and Italian stage 1 landed 2026-09-25**; the rest of those four and the other languages are open — detail in §3 OPEN (continued).
