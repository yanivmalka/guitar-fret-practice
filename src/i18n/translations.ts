...
const he: Record<string, string> = {
  ...
  'Vibrate': 'רטט',
  'Silent': 'שקט',
  'How the drill answers back. Sound: note playback, chimes and tap sounds. Vibrate: no sound — a buzz on every button press and on right / wrong answers instead. Silent: no sound and no per-button buzz, just a buzz on right / wrong answers plus the on-screen celebrations. Vibrate and Silent are great for practising with headphones off or a guitar in hand.':
    'איך התרגול מגיב. קול: השמעת התו, צלילי "נכון" וצלילי הקשה. רטט: בלי צליל — במקום זה רטט על כל לחיצת כפתור ועל תשובה נכונה / שגויה. שקט: בלי צליל ובלי רטט על לחיצות כפתור, רק רטט על תשובה נכונה / שגויה ובנוסף החגיגות על המסך. רטט ושקט מצוינים לתרגול בלי אוזניות או עם גיטרה אמיתית ביד.',
