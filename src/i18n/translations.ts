...
const he: Record<string, string> = {
  ...
  'Locrian': 'לוקרי',
  'Phrygian Dominant': 'פריגי דומיננטי',
  'Major Blues': 'בלוז מז\'ורי',
  'Half-Whole Diminished': 'מוקטן חצי־שלם',
  'Whole-Half Diminished': 'מוקטן שלם־חצי',
  'Whole Tone': 'טונים שלמים',
  'Lydian Dominant': 'לידי דומיננטי',
  'Altered': 'אלטרד',
  'Double Harmonic': 'הרמוני כפול',
  'Hungarian Minor': 'מינור הונגרי',
  'Hirajoshi': 'הירג\'ושי',
  'All scales': 'כל הסולמות',
  'More scales': 'סולמות נוספים',
  'Modes': 'מודוסים',
  'Minor variations': 'גוונים של מינור',
